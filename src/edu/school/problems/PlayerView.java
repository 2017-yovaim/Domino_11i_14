...
public class PlayerView extends JComponent
{
	...
	public PlayerView(DominoPlayer p)
	{
		this.player = p;
		player.addPlayerEventListener(new PlayerEventListener() 
		{
			@Override
			public void onPlayerChanged(DominoPlayer player) 
			{
				PlayerView.this.repaint();
			}
	...
	public void paintComponent(Graphics graphics)
	{
		...
		//Iterator<DominoTile> it = .getDominoTable().getIterator();
		while(it.hasNext())
		{
			g.translate(x, y);
			paintTile(g, it.next());
